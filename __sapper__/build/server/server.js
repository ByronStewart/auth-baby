...
/* src\routes\register.svelte generated by Svelte v3.6.3 */
...
/* src\routes\secret.svelte generated by Svelte v3.6.3 */
...
const Secret = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { user } = $$props;

	if ($$props.user === void 0 && $$bindings.user && user !== void 0) $$bindings.user(user);

	return `<h1>This is supposed to be secret</h1>
	<p>${escape(user.username)} you are one of the special ones</p>`;
});
...
/* src\routes\login.svelte generated by Svelte v3.6.3 */
...
const css$1 = {
	code: "nav.svelte-1g78bui{border-bottom:1px solid rgba(255, 62, 0, 0.1);font-weight:300;padding:0 1em}ul.svelte-1g78bui{margin:0;padding:0}ul.svelte-1g78bui::after{content:\"\";display:block;clear:both}li.svelte-1g78bui{display:block;float:left}.selected.svelte-1g78bui{position:relative;display:inline-block}.selected.svelte-1g78bui::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(255, 62, 0);display:block;bottom:-1px}a.svelte-1g78bui{text-decoration:none;padding:1em 0.5em;display:block}",
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-1g78bui">
	  <ul class="svelte-1g78bui">
	    <li class="svelte-1g78bui">
	      <a class="${escape(segment === undefined ? 'selected' : '')} svelte-1g78bui" href=".">home</a>
	    </li>
	    <li class="svelte-1g78bui">
	      <a class="${escape(segment === 'about' ? 'selected' : '')} svelte-1g78bui" href="about">about</a>
	    </li>
	    <li class="svelte-1g78bui">
	      <a class="${escape(segment === 'login' ? 'selected' : '')} svelte-1g78bui" href="login">login</a>
	    </li>
	    <li class="svelte-1g78bui">
	      <a class="${escape(segment === 'register' ? 'selected' : '')} svelte-1g78bui" href="register">
	        register
	      </a>
	    </li>
	    <li class="svelte-1g78bui">
	      <a class="${escape(segment === 'secret' ? 'selected' : '')} svelte-1g78bui" href="secret">secret</a>
	    </li>
	    <li class="svelte-1g78bui">
	      <a href="/api/logout" class="svelte-1g78bui">logout</a>
	    </li>
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/secret\/?$/,
			parts: [
				{ name: "secret", file: "secret.svelte", component: Secret, preload: preload }
			]
		},
...
/* src\node_modules\@sapper\internal\App.svelte generated by Svelte v3.6.3 */
